...
{
    eye.x = zoom * std::cos(glm::radians(phi)) * std::cos(glm::radians(theta)) + ref.x;
    eye.y = zoom * std::sin(glm::radians(phi)) + ref.y;
    eye.z = zoom * std::cos(glm::radians(phi)) * std::sin(glm::radians(theta)) + ref.z;
